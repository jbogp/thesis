...
\newcommand*\platyfull{\species{{P}latynereis dumerilii}}
\newcommand*\platy{\species{{P}. dumerilii}}
\newcommand*\todo[1]{\textcolor{BurntOrange}{#1}}
\newcommand*\microm[1]{\emph{$\mu m^{#1}$}}
\newcommand*\rev[2][]{\textcolor{red}{#2}\marginpar{\textcolor{red}{#1}}}
...
\cleardoublepage
\part{Cell types and single cells, a very spatial relationship}
