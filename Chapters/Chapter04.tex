...
\caption{EM algorithm}          % give the algorithm a caption
\label{alg1}                           % and a label for \ref{} commands later in the document
\begin{algorithmic}                    % enter the algorithmic environment
    \IF{Initialization is provided}
    ...
    \PRINT{Init successful and initial likelihood}
    \PRINT{Starting EM Procedure}
    \WHILE{cluster changed at iter $(l-1)$ < convergence}
